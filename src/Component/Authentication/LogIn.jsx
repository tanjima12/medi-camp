          ...
          <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
            <div className="mx-auto max-w-lg text-center">
              ...
              <p className="mt-4 text-gray-500">
                Welcome to our Medical Camp website! We are delighted to have
                you here. At CareCamp, we are dedicated to promoting health and
                well-being within our community. Explore our website to discover
                upcoming events, valuable resources, and information about our
                mission to provide accessible healthcare.
              </p>
            </div>
